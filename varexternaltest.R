...
c2 = (IRchange!=0) #c2 = dummy for if IR changes or not
...
data.df$year = c(data.df$year[2:400], 33)
...
plot(response.time, irfs1[,1], xlim=c(1.4, 12), ylim=c(-0.4, 1.0), xlab = "", ylab = "Market Return", main = "US Total Market", type = "l", cex.lab=1.2, cex.axis=1.2)
...
plot(response.time, irfs2[,1], xlim=c(1.4, 12), ylim=c(-0.95, 0.55), xlab = "", ylab = "Market Return", main = "Consumer Discretionary", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs3[,1], xlim=c(1.4, 12), ylim=c(-0.9, 0.3), xlab = "", ylab = "Market Return", main = "Consumer Stationary", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs4[,1], xlim=c(1.4, 12), ylim=c(-0.45, 3.9), xlab = "", ylab = "Market Return", main = "Energy", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs5[,1], xlim=c(1.4, 12), ylim=c(-0.9, 1.25), xlab = "", ylab = "Market Return", main = "Financials", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs6[,1], xlim=c(1.4, 12), ylim=c(-0.7, 0.45), xlab = "", ylab = "Market Return", main = "Healthcare", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs7[,1], xlim=c(1.4, 12), ylim=c(-0.5, 1.5), xlab = "", ylab = "Market Return", main = "Industrials", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs8[,1], xlim=c(1.4, 12), ylim=c(-0.95, 1.25), xlab = "", ylab = "Market Return", main = "Information Technology", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs9[,1], xlim=c(1.4, 12), ylim=c(-0.6, 2.25), xlab = "", ylab = "Market Return", main = "Materials", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs10[,1], xlim=c(1.4, 12), ylim=c(-0.65, 0.95), xlab = "", ylab = "Market Return", main = "Real Estate", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs11[,1], xlim=c(1.4, 12), ylim=c(-0.6, 0.62), xlab = "", ylab = "Market Return", main = "Telecommunications", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
...
plot(response.time, irfs12[,1], xlim=c(1.4, 12), ylim=c(-0.2, 0.95), xlab = "", ylab = "Market Return", main = "Utilities", type = "l", cex.lab=1.2, cex.axis=1.2)
polygon(c(response.time, rev(response.time)), c(lb[,1], rev(ub[,1])), col='grey90', border=FALSE)
